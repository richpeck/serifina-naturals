...
class SinatraApp < Sinatra::Base
  ...
  get '/' do
    ...
    shopify_session do |shop_name|
      ...
      @charms   = Charm.all
      @stones   = Stone.all.joins(:stone_type).select("stones.id, stones.name, stones.price, nodes.name AS stone_type_name_item").order(stone_type_name_item: :asc).group(:id, :stone_type_name_item).references(:stone_type)
